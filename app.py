...
ASSESSORES = [
    {"id": "bruna", "nome": "Bruna", "cor": "#FF5D73", "dias_total": 20},
    {"id": "made", "nome": "Madê", "cor": "#35D0BA", "dias_total": 20},
    {"id": "luana", "nome": "Luana", "cor": "#FFCB47", "dias_total": 20},
    {"id": "diego", "nome": "Diego", "cor": "#6C7BFF", "dias_total": 20},
    {"id": "francely", "nome": "Francely", "cor": "#4CD97B", "dias_total": 20},
    {"id": "lizia", "nome": "Lizia", "cor": "#FF8FD6", "dias_total": 20},
    {"id": "jarlene", "nome": "Jarlene", "cor": "#4FB6FF", "dias_total": 21},
]
...
DEFAULTS_PLACAR = {}
for a in ASSESSORES:
    DEFAULTS_PLACAR[a["id"]] = {"ml": 0, "vl": 0, "dp": 0}
    ...
    with st.form("form_placar"):
        ...
        for i, a in enumerate(ASSESSORES):
            ...
            with col:
                ...
                dp = st.number_input(
                    f"Dias Passados (de {a['dias_total']})",
                    min_value=0,
                    max_value=a["dias_total"],
                    value=int(atual.get("dp", 0)),
                    key=f"dp_{aid}",
                )
                novo_placar[aid] = {"ml": ml, "vl": vl, "dp": dp}
...
for a in ASSESSORES:
    ...
    init_lines.append(f'  document.getElementById("dp_{aid}").value = {int(valores.get("dp", 0))};')
...
components.html(html_final, height=1500, scrolling=False)
